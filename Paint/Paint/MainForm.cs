...
namespace Paint
{
    ...
    {
        public const int IMAGE_LENGTH = 649;
            ...
            if (ready && gcode != null)
            {
                try
                {
                    ...
                    if (line != gcode.Length)
                    {
                        _serialPort.Write(gcode[line] + "\n");
                        ready = false;
                        lblstatus.Text = line + " of " + (gcode.Length - 1) + " (" + line * 100 / (gcode.Length - 1) + "%)";
        ...
        private bool SendRaster(string data)
        {
            try
            {
                ...
                if (data == "2")
                {
                    ...
                    lblstatus.Text = counter + " of " + (totalsteps - 1) + " (" + counter * 100 / (totalsteps - 1) + "%)";
                    progressbar.Visible = true;
            ...
            if (IsPainting)
            {
                ...
                if (LastPos != e.Location)
                {
                    ...
                    else
                    {
                        ...
                        lblgcode.Text += "G01 X" + laserX + " Y" + laserY + " Z0\n";
                    }
